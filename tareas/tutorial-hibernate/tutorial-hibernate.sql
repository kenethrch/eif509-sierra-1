...
--
-- Host: localhost    Database: tutorial_hibernate
-- ------------------------------------------------------
...
CREATE TABLE `company` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_company_contact_id` FOREIGN KEY (`id`) REFERENCES `contact` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `person` VALUES (1,'Matt','Raible');
...
--
-- Dumping routines for database 'tutorial_hibernate'
--
...
-- Dump completed on 2015-08-23 22:04:23
